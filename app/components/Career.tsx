...
const jobs: Job[] = [
  {
    ...
    bullets: [
      ...
      "LLM API（ChatGPT/Gemini）を活用したAI占い機能・SEO記事自動生成・AIエージェント（法務 / 決済 / QA）自作",
    ...
    tech: ["AWS", "Terraform", "PHP", "Next.js", "Node.js", "Flutter", "LLM API", "Transformers", "Langfuse", "LangSmith", "GA4", "BigQuery", "Looker Studio", "LINE API", "OWASP ZAP"],
  },
  {
